...
const Navbar = () => {
    ...
    const toggleList = () => {
        const list = document.getElementById('navigator');

        list.classList.toggle('navigator-active');
    }
    ...
    return (
        <div className='navbar'>
            ...
            <div className='navigator' id='navigator' onClick={toggleList}>
            ...
            <button className='hamburger' onClick={toggleList}>
                <svg viewBox="0 0 21 21" xmlns="http://www.w3.org/2000/svg"><g fill="none" fillRule="evenodd" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"><path d="m4.5 6.5h12" /><path d="m4.498 10.5h11.997" /><path d="m4.5 14.5h11.995" /></g></svg>
            </button>
        </div>
    )
}
